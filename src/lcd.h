...
enum display_row {
  ...
  DISPLAY_ROW_TEMPVALUE,     // 3
	DISPLAY_ROW_AMBLIGHTVALUE, // 4
	DISPLAY_ROW_SOUNDLEVEL,    // 5
  DISPLAY_ROW_OCCUPIED,      // 6
  DISPLAY_ROW_7,             // 7
	DISPLAY_ROW_PASSKEY,       // 8
	DISPLAY_ROW_ACTION,        // 9
  DISPLAY_ROW_ACTION2,       // 10
	DISPLAY_ROW_11,            // 11
	DISPLAY_ROW_TEAMNAME,      // 12
